...
if (strtolower(trim($action)) == 'y') {
    ...
    $response = _post('https://www.ip2location.com/download-info', $queries);
    ...
    $response = _post('https://www.ip2location.com/download', $queries, $fileName);
...
function _post($url, $fields = [], $file = ''): string | true {
    $ch = curl_init();
