...
final class Users extends AbstractMigration
{
    ...
    public function change(): void
    {
        ...
        $table->addColumn('username', 'string', ['limit' => 30])
            ...
            ->addColumn('twofa_default_type', 'enum', ['values' => User::EMAIL.','.User::GOOGLE2FA, 'default' => User::EMAIL])
            ->addColumn('twofa_types', 'string', ['null' => true])              //will contain comma seperated string of on or more of the above
